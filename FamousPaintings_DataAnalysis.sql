-- 01. Top 5 most popular artists?
-- Popularity is based on most number of paintings done by an artist
...
-- 01. Countries and its Museums
SELECT country, name
FROM museum
GROUP BY country, name
ORDER BY country, name;

-- 02. Museums which are open every single day?
...
-- 03. Which are the top 5 most popular museums? 
...
-- 04. Which country has the 5th highest number of paintings?
SELECT	m.country,
...
-- 06. Top 5 museums with highest number of painting styles
...
-- 07. How many paintings which are not displayed at any museums?
SELECT COUNT(distinct name) AS paintings_count
FROM work
WHERE museum_id = '';

-- 08. Are there any museums without any paintings?
SELECT *
FROM museum m
LEFT JOIN work
USING (museum_id)
...
-- 01. Top 10 most popular painting subjects
SELECT 	subject,
		COUNT(*) AS paintings_count
FROM subject
GROUP BY subject
...
-- 02. Top/Bottom 3 popular painting styles
SELECT *
...
-- 03. Top 10 paintings with the highest price
...
-- 04. How many paintings have an asking price higher than the regular price?
SELECT COUNT(*) AS paintings_count
FROM product_size
WHERE sale_price > regular_price;

-- 05. Identify the paintings whose asking price is less than 50% of its regular price
...
-- 06. Which canvas size costs the most?
...
-- 07. Top 5 least popular canvas sizes?
